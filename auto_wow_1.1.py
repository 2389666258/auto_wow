...
''' 坐标位置 '''
# 选择商品 的坐标位置
choose_position_x = 500
choose_position_y = 275
# 选择商品 的偏移量
choose_position_offset = 40
...
''' 预设值 '''
# 定义预设值
preset_values = [500, 500, 100, 50, 100, 62, 400, 800]
...
class ScreenCaptureOCR:
    ...
    def process_price_list_region(self, region=None):
        while True:
            ...
            # 选择商品 的坐标位置
            choose_positions = [(choose_position_x, choose_position_y + choose_position_offset * i)
                                for i in range(len(self.preset_values))]

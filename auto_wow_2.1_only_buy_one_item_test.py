...
# 家
# 设置价格为 9999999 时 强行实现究极对齐 金 & 金 & 金
price_confirm_region = (1215, 307, 1267, 415)
    ...
    def process_price_list_region(self, region=None):
        ...
        while True:
            ...
            while True:
                ...
                """ 进行价格确认 """
                if self.process_price_confirm_region(price_confirm_region) == 0:
                    # 点击 刷新
                    # sleep(interval)
                    # sleep(interval)
                    # sleep(interval)
                    ...
                    purchase_count = 0
                    continue
                elif self.process_price_confirm_region(price_confirm_region) == 2:
                    # 重启拍卖行
